...
NOTE: For OS X users, `brew install ditaa` gives you an executable `ditaa` without the helper script.
...
with more detail in <<Elements of the Header>>.
...
as detailed in <<Elements of the Header>>.
For example:
