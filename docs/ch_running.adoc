...
You will also want to refer to Tali's <<Glossary of Forth Words>> for the list of words that
...
The <<Glossary of Forth Words>> contains a list of all the words Tali comes with, where they come from,
...
Tali Forth and refer to the <<Glossary of Forth Words>>.
