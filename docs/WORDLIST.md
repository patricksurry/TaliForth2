...
| FIND_NAME | `find-name` | Gforth | 114 | **auto** |
| FNV1A | `fnv1a` | Tali Forth | 22 | tested |
...
| SEARCH_WORDLIST | `search-wordlist` | ANS search | 100 | **auto** |
