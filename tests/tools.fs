...
create saw 2 allot -1 saw !
: see-saw-output s\" \n
nt: *  xt: *  header: C0 03 ?? 05 \n
...
T{ capture-output see saw restore-output 2dup type see-saw-output compare-glob -> 0 }T

\ this used to check HC flag when variables still had that...
