...
\ Test TO with mixed nc-limit combinations to force
\ native vs non-native VALUE and TO bodies

\ inline VALUE and jsr TO
256 nc-limit !
T{ 100 value to-xval1 -> }T
T{ to-xval1 -> 100 }T
0 nc-limit !
T{ : hi-lo to to-xval1 ; -> }T
T{ 200 hi-lo -> }T
T{ to-xval1 -> 200 }T
old-nc-limit nc-limit !

0 nc-limit !
T{ 100 value to-xval2 -> }T
T{ to-xval2 -> 100 }T
256 nc-limit !
T{ : lo-hi to to-xval2 ; -> }T
T{ 200 lo-hi -> }T
T{ to-xval2 -> 200 }T
old-nc-limit nc-limit !
