;----------------------------------------------------------------------
; An alternative DUMP for narrower screens.
;
; It shows 8 bytes per line rather than 16, and aligns rows to multiples of 8.
; For example:
;
; 5 20 dmp
; 0005                 E5 9E 50       ..P
...
; ## DMP ( addr n -- ) "Show memory dump of n bytes at addr in hex and ascii"
; ## "dmp"  contrib
