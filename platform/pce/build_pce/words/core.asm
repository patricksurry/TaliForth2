...
w_literal:
                ...
                ; we could also check zpage+0,x and compile w_zero to save another byte
...
plus_loop_runtime:
        ...
        ; """
                ...
                lda zpage+$FF,x               ; MSB of step since zpage+1,x == -zpage+1,x+2
...
; ## "to"  auto  ANS core ext
        ...
        ;   ldy #MSB / lda #LSB / dex / dex / sta zpage+0,x / sty zpage+1,x / rts
...
w_um_slash_mod:
                ...
                ;       +-----------+-----------+-----------+
                ;       |    TOS    |    NOS    |    3OS    |
                ;       | zpage+0,x | zpage+1,x | zpage+2,x | zpage+3,x | zpage+4,x | zpage+5,x |
                ;       +-----+-----+-----+-----+-----+-----+
                ;       |  divisor  |       dividend        |
                ...
                ;       +-----------+-----------+
                ;       |    TOS    |    NOS    |
                ;       | zpage+0,x | zpage+1,x | zpage+2,x | zpage+3,x |
                ;       +-----+-----+-----+-----+
                ;       | quotient  | remainder |
                ;       | qlo   qhi | rlo   rhi |
                ;       +-----------+-----------+
...
_outer_loop:
                ...
                lsr zpage+4,x         ; think "zpage+2,x" the first time and "zpage+3,x" the next
                bcs +
...
_no_add:
                ror
                ror tmp1
                ror zpage+4,x         ; first "zpage+2,x" then "zpage+3,x"
