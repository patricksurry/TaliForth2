...
_command_mode:
                ...
                sta zpage+2,x
                lda ed_cur+1
                sta zpage+3,x                 ; ( addr-t u-t cur 0 )
...
_whole_text:
                ...
                lda #01
                sta zpage+2,x                 ; LSB of NOS is para 1
                stz zpage+3,x                 ; ( addr-t u-t para1 0 )
...
_got_comma:
                ...
                inc zpage+2,x
                bne +
                inc zpage+3,x                 ; ( addr-t u-t para1 0 addr2+1 u2 )
+
                lda zpage+1,x
                beq +
                dec zpage+1,x
+
                dec zpage+0,x                 ; ( addr-t u-t para1 0 addr2+1 u2-1 )
...
;                sta zpage+0,x
;                lda ed_cur+1
;                sta zpage+1,x                 ;  ( addr-t u-t cur ) drop through
...
+
                ...
                sta zpage+2,x
                lda ciblen+1
                sta zpage+3,x                 ; ( addr-t u-t here ciblen here2+2 )
...
ed_cmd_equ:
        ...
        ; the last line is ("$=")
                ...
                dex
                stz zpage+0,x
                stz zpage+1,x                 ; ( addr-t u-t para1 para2 0 )
                bra _cmd_equ_done
...
+
                ...
                sta zpage+2,x
                lda 7,x
                sta zpage+3,x                 ; ( addr-t u-t addr-t ? )
...
_cmd_w_para_ready:
                ...
                sta zpage+0,x
                lda #>ed_head
                sta zpage+1,x                 ; ( addr-t u-t addr-t addr-h )
...
_cmd_w_eol:
                ...
                sta zpage+4,x
                lda zpage+1,x
                sta zpage+5,x                 ; ( addr-t u addr-n u )
