...
_loop:
                pha
                lda zpage+0,x                 ; fetch wid to A and drop it
                inx
                inx
...
+
 ...
 _drop_fail:
                ...
                inx
+
                sta zpage+0,x                 ; A is -1, 0 or 1
                cmp #1
                bne +
                dec a                   ; for 1 we store <1,0>
+
                sta zpage+1,x                 ; for 0 and -1 we store the same value twice
_done:
z_search_wordlist:
                rts
...
w_set_current:
                ...
                ldy #current_offset
                lda zpage+0,x         ; CURRENT is byte variable
...
w_set_order:
                ; Test for -1 TOS.
                lda zpage+1,x         ; just check MSB sign bit since other negative
...
_loop:
                ...
                lda zpage+0,x         ; The search order is a byte array
